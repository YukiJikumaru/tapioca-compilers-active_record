...
class PostTagRelation
  ...
  module ::PostTagRelation::GeneratedAttributeMethods
    ...
    def post_id_previously_changed?(from: nil, to: nil); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def tag_id_previously_changed?(from: nil, to: nil); end
  ...
  class ActiveRecord_AssociationRelation < ::ActiveRecord::Relation
    ...
    sig { params(other: T.untyped).returns(PostTagRelation) }
    ...
    sig { params(arg: T.untyped).returns(PostTagRelation) }
    def find(arg); end
    ...
    sig { params(limit: ::Integer).returns(T::Array[PostTagRelation]) }
