...
module DRb
  ...
  #
  # source://drb//lib/drb/drb.rb#1831
  def config; end
  ...
  #
  # source://drb//lib/drb/drb.rb#1788
  ...
  # See #current_server.
  #
  # source://drb//lib/drb/drb.rb#1842
  def front; end
  ...
  #
  # source://drb//lib/drb/drb.rb#1879
  ...
  #
  # source://drb//lib/drb/drb.rb#1775
  ...
  #
  # source://drb//lib/drb/drb.rb#1911
  def regist_server(server); end

  # Removes +server+ from the list of registered servers.
  #
  # source://drb//lib/drb/drb.rb#1920
  ...
  # See DRbServer::new.
  #
  # source://drb//lib/drb/drb.rb#1767
  ...
  #
  # source://drb//lib/drb/drb.rb#1800
  ...
  #
  # source://drb//lib/drb/drb.rb#1868
  def thread; end
  ...
  # See #current_server.
  #
  # source://drb//lib/drb/drb.rb#1859
  def to_id(obj); end
  ...
  #
  # source://drb//lib/drb/drb.rb#1809
  def uri; end
...
class DRb::DRbArray
  ...
  # source://drb//lib/drb/drb.rb#541
  def _dump(lv); end

  class << self
    # source://drb//lib/drb/drb.rb#537
    def _load(s); end
  end
end
...
#
# source://drb//lib/drb/drb.rb#1255
class DRb::DRbConn
  # @return [DRbConn] a new instance of DRbConn
  #
  # source://drb//lib/drb/drb.rb#1316
  def initialize(remote_uri); end

  # @return [Boolean]
  #
  # source://drb//lib/drb/drb.rb#1332
  def alive?; end

  # source://drb//lib/drb/drb.rb#1327
  def close; end

  # source://drb//lib/drb/drb.rb#1322
  ...
  class << self
    # source://drb//lib/drb/drb.rb#1258
    def make_pool; end

    # source://drb//lib/drb/drb.rb#1296
    def open(remote_uri); end

    # source://drb//lib/drb/drb.rb#1291
    def stop_pool; end
  end
end
...
class DRb::DRbMessage
  ...
  # source://drb//lib/drb/drb.rb#561
  def dump(obj, error = T.unsafe(nil)); end

  # @raise [DRbConnError]
  #
  # source://drb//lib/drb/drb.rb#578
  def load(soc); end

  # source://drb//lib/drb/drb.rb#638
  def recv_reply(stream); end

  # @raise [DRbConnError]
  #
  # source://drb//lib/drb/drb.rb#618
  def recv_request(stream); end

  # source://drb//lib/drb/drb.rb#632
  def send_reply(stream, succ, result); end

  # source://drb//lib/drb/drb.rb#604
  def send_request(stream, ref, msg_id, arg, b); end

  private

  # source://drb//lib/drb/drb.rb#645
...
class DRb::DRbObject
  ...
  #
  # source://drb//lib/drb/drb.rb#1088
  ...
  #
  # source://drb//lib/drb/drb.rb#1114
  def __drbref; end

  # Get the URI of the remote object.
  #
  # source://drb//lib/drb/drb.rb#1109
  def __drburi; end
  ...
  # source://drb//lib/drb/drb.rb#1134
  def method_missing(msg_id, *a, &b); end

  # source://drb//lib/drb/drb.rb#1186
  def pretty_print(q); end

  # source://drb//lib/drb/drb.rb#1190
  ...
  # @return [Boolean]
  #
  # source://drb//lib/drb/drb.rb#1122
...
# drb distribution.
#
# source://drb//lib/drb/drb.rb#720
module DRb::DRbProtocol
  private

  # Add a new protocol to the DRbProtocol module.
  #
  # source://drb//lib/drb/drb.rb#723
  def add_protocol(prot); end

  # source://drb//lib/drb/drb.rb#801
...
class DRb::DRbServer
  ...
  #
  # source://drb//lib/drb/drb.rb#1450
  ...
  # @raise [ArgumentError]
  #
  # source://drb//lib/drb/drb.rb#1593
  def check_insecure_method(obj, msg_id); end

  # The configuration of this DRbServer
  #
  # source://drb//lib/drb/drb.rb#1492
  def config; end
  ...
  #
  # source://drb//lib/drb/drb.rb#1489
  def front; end
  ...
  # @return [Boolean]
  #
  # source://drb//lib/drb/drb.rb#1510
  def here?(uri); end

  # Stop this server.
  #
  # source://drb//lib/drb/drb.rb#1515
  def stop_service; end
  ...
  # session.
  #
  # source://drb//lib/drb/drb.rb#1483
  def thread; end

  # Convert a local object to a dRuby reference.
  #
  # source://drb//lib/drb/drb.rb#1532
  def to_id(obj); end

  # Convert a dRuby reference to the local object it refers to.
  #
  # source://drb//lib/drb/drb.rb#1525
  def to_obj(ref); end

  # The URI of this DRbServer.
  #
  # source://drb//lib/drb/drb.rb#1476
  def uri; end
  ...
  #
  # source://drb//lib/drb/drb.rb#1502
  def verbose; end
  ...
  # In verbose mode, failed calls are logged to stdout.
  #
  # source://drb//lib/drb/drb.rb#1497
  def verbose=(v); end
  ...
  #
  # source://drb//lib/drb/drb.rb#1579
  ...
  # @return [Boolean]
  #
  # source://drb//lib/drb/drb.rb#1573
  ...
  #
  # source://drb//lib/drb/drb.rb#1713
  def main_loop; end
  ...
  class << self
    ...
    #
    # source://drb//lib/drb/drb.rb#1374
    ...
    #
    # source://drb//lib/drb/drb.rb#1360
    ...
    #
    # source://drb//lib/drb/drb.rb#1381
    ...
    #
    # source://drb//lib/drb/drb.rb#1367
    def default_load_limit(sz); end

    # source://drb//lib/drb/drb.rb#1397
    def make_config(hash = T.unsafe(nil)); end

    # Get the default value of the :verbose option.
    #
    # source://drb//lib/drb/drb.rb#1393
    def verbose; end
    ...
    #
    # source://drb//lib/drb/drb.rb#1388
    def verbose=(on); end
  end
end

# source://drb//lib/drb/drb.rb#1623
class DRb::DRbServer::InvokeMethod
  ...
  # source://drb//lib/drb/drb.rb#1629
  def perform; end

  private

  # source://drb//lib/drb/drb.rb#1666
  def check_insecure_method; end

  # source://drb//lib/drb/drb.rb#1658
  def init_with_client; end

  # source://drb//lib/drb/drb.rb#1675
  def perform_without_block; end

  # source://drb//lib/drb/drb.rb#1670
...
class DRb::DRbTCPSocket
  ...
  # @return [Boolean]
  #
  # source://drb//lib/drb/drb.rb#1000
  def alive?; end
  ...
  #
  # source://drb//lib/drb/drb.rb#952
  def close; end

  # Get the address of our TCP peer (the other end of the socket
  # we are bound to.
  #
  # source://drb//lib/drb/drb.rb#917
  def peeraddr; end

  # On the client side, receive a reply from the server.
  #
  # source://drb//lib/drb/drb.rb#940
  def recv_reply; end

  # On the server side, receive a request from the client.
  #
  # source://drb//lib/drb/drb.rb#930
  def recv_request; end

  # On the server side, send a reply to the client.
  #
  # source://drb//lib/drb/drb.rb#935
  def send_reply(succ, result); end

  # On the client side, send a request to the server.
  #
  # source://drb//lib/drb/drb.rb#925
  def send_request(ref, msg_id, arg, b); end

  # source://drb//lib/drb/drb.rb#1009
  def set_sockopt(soc); end

  # Graceful shutdown
  #
  # source://drb//lib/drb/drb.rb#995
  def shutdown; end

  # Get the socket.
  #
  # source://drb//lib/drb/drb.rb#922
  def stream; end

  # Get the URI that we are connected to.
  #
  # source://drb//lib/drb/drb.rb#913
  def uri; end

  private

  # source://drb//lib/drb/drb.rb#985
  def accept_or_shutdown; end

  # source://drb//lib/drb/drb.rb#961
  def close_shutdown_pipe; end

  class << self
    # Returns the hostname of this server
    #
    # source://drb//lib/drb/drb.rb#844
    ...
    # URI protocols.
    #
    # source://drb//lib/drb/drb.rb#837
    def open(uri, config); end

    # Open a server listening for connections at +uri+ using
    # configuration +config+.
    #
    # source://drb//lib/drb/drb.rb#875
    ...
    #
    # source://drb//lib/drb/drb.rb#860
    def open_server_inaddr_any(host, port); end

    # source://drb//lib/drb/drb.rb#817
    def parse_uri(uri); end

    # Parse +uri+ into a [uri, option] pair.
    #
    # source://drb//lib/drb/drb.rb#892
...
# source://drb//lib/drb/drb.rb#1020
class DRb::DRbURIOption
  ...
  # source://drb//lib/drb/drb.rb#1027
  def ==(other); end

  # source://drb//lib/drb/drb.rb#1027
  def eql?(other); end

  # source://drb//lib/drb/drb.rb#1032
  def hash; end
...
class DRb::DRbUnknown
  ...
  #
  # source://drb//lib/drb/drb.rb#483
  def buf; end

  # Create a DRbUnknownError exception containing this object.
  #
  # source://drb//lib/drb/drb.rb#507
  def exception; end
...
class DRb::DRbUnknownError < ::DRb::DRbError
  ...
  class << self
    # source://drb//lib/drb/drb.rb#420
    def _load(s); end
  end
end

# source://drb//lib/drb/drb.rb#1198
class DRb::ThreadObject
  ...
  # source://drb//lib/drb/drb.rb#1236
  def _execute; end

  # @return [Boolean]
  #
  # source://drb//lib/drb/drb.rb#1212
  def alive?; end

  # source://drb//lib/drb/drb.rb#1216
  def kill; end

  # source://drb//lib/drb/drb.rb#1221
...
# :stopdoc:
#
# source://drb//lib/drb/drb.rb#1940
