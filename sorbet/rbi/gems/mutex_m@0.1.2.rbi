...
module Mutex_m
  # source://mutex_m//lib/mutex_m.rb#113
  def initialize(*args); end

  # source://mutex_m//lib/mutex_m.rb#66
  def mu_extended; end

  # See Thread::Mutex#lock
  #
  # source://mutex_m//lib/mutex_m.rb#93
  def mu_lock; end
  ...
  # @return [Boolean]
  #
  # source://mutex_m//lib/mutex_m.rb#83
  def mu_locked?; end

  # See Thread::Mutex#synchronize
  #
  # source://mutex_m//lib/mutex_m.rb#78
  def mu_synchronize(&block); end

  # See Thread::Mutex#try_lock
  #
  # source://mutex_m//lib/mutex_m.rb#88
  def mu_try_lock; end

  # See Thread::Mutex#unlock
  #
  # source://mutex_m//lib/mutex_m.rb#98
  def mu_unlock; end

  # See Thread::Mutex#sleep
  #
  # source://mutex_m//lib/mutex_m.rb#103
  def sleep(timeout = T.unsafe(nil)); end

  private

  # source://mutex_m//lib/mutex_m.rb#109
  def mu_initialize; end

  class << self
    # source://mutex_m//lib/mutex_m.rb#56
    def append_features(cl); end

    # source://mutex_m//lib/mutex_m.rb#46
    def define_aliases(cl); end

    # source://mutex_m//lib/mutex_m.rb#61
