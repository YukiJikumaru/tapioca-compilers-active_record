...
module Tapioca
  module Compilers
    class ActiveRecord < Tapioca::Dsl::Compiler
      ...
      def decorate
# root => RBI::Tree
# constant => A model inherits ActiveRecord::Base == self.gather_constants
# model => RBI::Class reprensents constant

# ('and', parameters: [create_param('other', type: T_UNTYPED)], return_type: T_SELF)
# ('annotate', parameters: [create_rest_param('args', type: '::String')], return_type: T_SELF)
# ('async!', return_type: T_SELF)
# ('create_with', parameters: [create_param('other', type: T_UNTYPED)], return_type: model_name)
# ('distinct', parameters: [create_opt_param('value', type: 'T::Boolean', default: 'false')], return_type: T_SELF)
...
# Post.columns # T::Array[ActiveRecord::ConnectionAdapters::MySQL::Column]
# Post.attribute_names # T::Array[String]
# Post.attribute_aliases # T::Hash[String, String]
# Post.attribute_types['id'] # ActiveModel::Type::Value
